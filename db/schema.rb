...
ActiveRecord::Schema[7.0].define(version: 2024_11_15_223838) do
  ...
  create_table "funky_texts", force: :cascade do |t|
    t.string "title"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  create_table "items", force: :cascade do |t|
    ...
    t.integer "munkapont_weight", default: 1
  end
  ...
  add_foreign_key "orders", "users", column: "completed_by_id"
end
